...
test_num = 348
test_num_pre=384
lr_change= [4*1e-7, 4*1e-7, 4*1e-6, 4*1e-6, 4*1e-5, 4*1e-5]
throw_rate=0.5
trainingset_num=[1920,960,480,240,120,120]
num_strategy=5
...
summary_save_dir= "summarydis01/"
acc_txt="accdis01.txt"
log_txt="logdis01.txt"
test_details="test_detaildis01.txt"
test_details_pre="test_detail_predis01.txt"
config_txt="configdis01.txt"
throw_txt="throwdis01.txt"
save_path='modeldis01'
with open("configdis01.txt", "w+")as f0:
    f0.write('mode: ' + mode)
    f0.write('\n')
    f0.flush()
...
def main():
    ...
    label_predict_op = net.inference_model_9(input,label_attention_map,label_polar_map)  # label_predict_op=(batch, n_steps, n_outputs)
    ...
    with tf.Session(config=tf_config) as sess:
        ...
        for i in range(len(list_img_path_train_init)):  # 1308
            ...
            with open('./data/train/label/all/' + list_img_path_train_init[i] + '.txt', 'r') as f:
                K = f.readlines()
