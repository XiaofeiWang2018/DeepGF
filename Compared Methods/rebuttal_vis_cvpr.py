        ...
        with tf.Session(config=tf_config, graph=graph) as sess:
            ...
            for i in range(6):
                ...
                for img_index in range(5):
                    ...
                    Image.imsave('visualization_result/cls_cvpr/guidedbp/img'  + str(i + 1) + '_' + str(
                        img_index+1)  + '_gbp.jpg', mask,cmap=plt.get_cmap('gray'))
                    Image.imsave(
                        'visualization_result/cls_cvpr/guidedbp/img' + str(i + 1) + '_' + str(img_index+1) + '.jpg', image[0][img_index])
