...
summary_save_dir= "summarym11/"
acc_txt="accm11.txt"
log_txt="logm11.txt"
test_details="test_detailm11.txt"
test_details_pre="test_detail_prem11.txt"
config_txt="configm11.txt"
throw_txt="throwm11.txt"
save_path='modelm11'
with open("configm11.txt", "w+")as f0:
    f0.write('mode: ' + mode)
    f0.write('\n')
    f0.flush()
...
def main():
    ...
    label_predict_op = net.inference_model_10(input,label_attention_map)  # label_predict_op=(batch, n_steps, n_outputs)
