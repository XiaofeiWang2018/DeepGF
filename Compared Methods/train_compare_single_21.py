...
summary_save_dir= "summarys21/"
acc_txt="accs21.txt"
log_txt="logs21.txt"
test_details="test_details21.txt"
test_details_pre="test_detail_pres21.txt"
config_txt="configs21.txt"
throw_txt="throws21.txt"
save_path='models21'
with open("configs21.txt", "w+")as f0:
    f0.write('mode: ' + mode)
    f0.write('\n')
    f0.flush()
