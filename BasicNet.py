...
from  LSTMCell_timegate import LSTMCell_timegate,LSTMCell_timegateKDD
...
class BasicNet(object):
    ...
    def lstm_gap_fc_timegateKDD(self, scope_name, x, n_layers, is_training,delta_year,init_a,init_b, state_is_tuple=True):
        """
        ...
        with tf.variable_scope(scope_name+'_lstm_gap'):
            ...
            channel=x.get_shape().as_list()[2]
            from tensorflow.contrib import rnn
            cell_1 = LSTMCell_timegateKDD(num_units=channel, state_is_tuple=state_is_tuple)
            cell_2 =  LSTMCell_timegateKDD(num_units=channel, state_is_tuple=state_is_tuple)
